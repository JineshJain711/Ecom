            ...
            return (
              <div key={order._id} style={{ background: '#09090b', padding: '20px', borderRadius: '12px', border: '1px solid #27272a', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '20px' }}>
                <div>
                  ...
                  <p style={{ color: '#a1a1aa', fontSize: '0.9rem' }}>Total: <strong style={{ color: '#10b981' }}>₹{total.toFixed(2)}</strong></p>
                </div>
                <div>
                  <span style={{ 
                    background: statusText === 'Delivered' ? 'rgba(16,185,129,0.1)' : statusText === 'Shipped' ? 'rgba(59,130,246,0.1)' : 'rgba(245,158,11,0.1)', 
                    color: statusText === 'Delivered' ? '#10b981' : statusText === 'Shipped' ? '#3b82f6' : '#f59e0b',
